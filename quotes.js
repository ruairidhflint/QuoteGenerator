...
{id: 21, name: "Oscar Wilde", quote: "A bore is someone who deprives you of solitude without providing you with company."},
{id: 22, name: "Friedrich Nietzsche", quote: "I'm not upset that you lied to me, I'm upset that from now on I can't believe you." },
{id: 23, name: "Chinese Proverb", quote: "He who asks is a fool for five minutes, but he who does not ask remains a fool forever." },
{id: 24, name: "Alan Watts", quote: "You're under no obligation to be the same person you were 5 minutes ago" },
{id: 25, name: "Isaac Newton", quote: "Tact is the art of making a point without making an enemy." },
{id: 26, name: "Marcus Aurelius", quote: "It never ceases to amaze me: we all love ourselves more than other people, but care more about their opinion than our own." },
{id: 27, name: "Mark Twain", quote: "The secret of getting ahead is getting started." },
{id: 28, name: "Viktor Frankl", quote: "When we are no longer able to change a situation - we are challenged to change ourselves" },
{id: 29, name: "Douglas Adams", quote: "Don't panic." },
{id: 30, name: "F. Scott Fitzgerald", quote: "For what it's worth: it's never too late, or in my case, too early to be whoever you want to be." },
{id: 31, name: "George Orwell", quote: "All animals are created equal, but some animals are created more equal than others." },
